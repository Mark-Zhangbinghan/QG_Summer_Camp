...
![1710952367244](C:\Users\24468\AppData\Roaming\Typora\typora-user-images\1710952367244.png)

![1710952309500](C:\Users\24468\AppData\Roaming\Typora\typora-user-images\1710952309500.png)

![1710952399385](C:\Users\24468\AppData\Roaming\Typora\typora-user-images\1710952399385.png)

![1710952438012](C:\Users\24468\AppData\Roaming\Typora\typora-user-images\1710952438012.png)

![1710952525801](C:\Users\24468\AppData\Roaming\Typora\typora-user-images\1710952525801.png)

```python
# 可变字符串实现
import io					# 库的引入
a = 'abcdefghijklmnop'
a = io.StringIO(a)			#实现a字符串的转化
print(a.getvalue())			#使转化后的字符串输出
a.seek(3)					#将索引指向序列号为3的位置
a.write("我喜欢你！")         #从序列位置开始向后改变，若不足则将字符串延伸
print(a.getvalue())
...
​    切片(slice)操作可以访问一定范围内的元素，语法如下所示：
...
- step：步长
![1710952730212](C:\Users\24468\AppData\Roaming\Typora\typora-user-images\1710952730212.png)
  
  ![1710952770401](C:\Users\24468\AppData\Roaming\Typora\typora-user-images\1710952770401.png)
...
list.("zhang")		# ['z','h','a','n','g']
# 使用list()函数可将表达式转化为列表
```
![1711036881524](C:\Users\24468\AppData\Roaming\Typora\typora-user-images\1711036881524.png)

![1711036908499](C:\Users\24468\AppData\Roaming\Typora\typora-user-images\1711036908499.png)
...
![1711033517636](C:\Users\24468\AppData\Roaming\Typora\typora-user-images\1711033517636.png)
...
![1711036736267](C:\Users\24468\AppData\Roaming\Typora\typora-user-images\1711036736267.png)

![1711032284711](C:\Users\24468\AppData\Roaming\Typora\typora-user-images\1711032284711.png)
...
```python
a = {x*2 for x in range(1,10) if x%2==0}   #将符合条件的元素生成入列表a中
# a = {16, 12, 4, 8}                        #集合是无序的
```
